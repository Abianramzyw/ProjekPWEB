...
include "connect.php";
    ...
    <div class="page-banner-section section bg-image" data-bg="assets/images/bg/car.png">
        <div class="container">
            <div class="row">
                <div class="col">
                            ...
                            <div class="tab-content" id="myaccountContent">
                                ...
                                <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                    <div class="myaccount-content">
                                        ...
                                        <?php 
                                        $query = mysqli_query($con,"SELECT MAX(kd_barang) as kd_barMAX FROM barang");
                                        $data = mysqli_fetch_array($query);
                                        $kd_barang = $data['kd_barMAX'];
                                        $urutancheck = (int) substr($kd_barang, 2, 3);
                                        $urutancheck++;
                                        $hurufcheck = "D";
                                        $kd_barang = $hurufcheck . sprintf("%03s", $urutancheck);
                                        ?>
                                        <div class="welcome mb-20">
                                            <form action="input_barang_act.php" method="POST">
                                                <table>
                                                    <tr>
                                                        <td>Kode Barang</td>
                                                        <td><input type="text" name="kd_barang"
                                                            value="<?php echo $kd_barang ?>" ></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Nama Barang</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="number" name="harga_barang"
                                                                ></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type="text" name="foto_besar"
                                                                ></td>
                                                    </tr>
                                                    <tr>
                                                        <td></td>
                                                        <td><button type="submit" value="Simpan"
                                                                class="place-order btn btn-lg btn-round">Simpan</td>
                                                    </tr>
                                                </table>
                                            </form>
                                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div
                        ...
                        <h2>REMOTE</h2>
                        <p class="contact-text">Jl.Kalimantan, Krajan Timur</p>
                        <p class="contact-text">Jember, Jawa Timur</p>
                        <p class="contact-text">Remote@gmail.com</p>
                        <p class="contact-text">(+62) 851-3311-0210</p>
                    </div>
                    <!--Footer Widget end-->
                </div>
            </div>
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="copyright text-left">
                                    <p>Copyright &copy;2022 <a href="#">Remote</a>. Hak cipta dilindungi undang-undang.</p>
