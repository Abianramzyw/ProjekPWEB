          ...
          <div class="container">
              <div class="row align-items-center">
                  <div class="col-xl-3 col-lg-2 col-md-4 col-12">
                      <!--Logo Area Start-->
                      <div class="logo-area">
                          <a href="index.php"><img src="./assets/images/logoo.png" alt=""></a>
                      ...
                      <div class="header-menu-area text-center">
                          <nav class="main-menu">
                              ...
                              <ul>
                                  ...
                                  <li><a href="shop.php">Rental Mobil</a>
                                  </li>

                                  <li><a href="about.php">Tentang Remote</a>
                                  </li>
                      ...
                      <div class="header-search-cart-area">
                          <ul>
                              ...
                              <li class="mini-cart"><a href="cart.php"><i class="flaticon-shopping-cart"></i> <span
                                          class="mini-cart-total">Pemesanan</span></a>
                                  <!--Mini Cart Dropdown Start-->
                                  <div class="header-cart">

                                      <div class="cart-btn">
                                          <a href="cart.php">Lihat Pemesanan</a>
                  ...
                  <div class="off-canvas-contact-widget">
                      <div class="header-contact-info">
                          <ul class="header-contact-info-list">
                              <li><i class="ion-android-phone-portrait"></i> <a href="tel:+62-85133110210">(+62) 851-3311-0210
                                  </a></li>
                              <li><i class="ion-android-mail"></i> <a
                                      href="mailto:remote@gmail.com">Remote@gmail.com</a></li>
                          </ul>
                      </div>
                  </div>
  ...
  <div class="main-search-active">
      ...
      <div class="sidebar-search-input">
          ...
          <p class="form-description">Cari Mobil yang Anda Inginkan</p>
      </div>
  </div>
  <!-- main-search start -->
